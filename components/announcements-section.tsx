...
import { Calendar, Sparkles, Bell, AlertCircle, ShieldAlert, Pin, ChevronRight } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="group relative rounded-3xl overflow-hidden border border-destructive/30 bg-destructive/10 backdrop-blur-xl shadow-lg shadow-black/20 transition-shadow duration-500">
            {/* Soft glow */}
            <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-destructive/15 blur-3xl group-hover:bg-destructive/25 transition-colors duration-500" />

            <div className="relative z-10 p-5 lg:p-6 2xl:p-8 flex flex-col sm:flex-row items-start gap-4 lg:gap-5">
              {/* Icon */}
              <div className="shrink-0 w-12 h-12 lg:w-14 lg:h-14 rounded-2xl bg-destructive flex items-center justify-center text-white shadow-lg shadow-destructive/30 ring-1 ring-white/20">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  <span className="inline-flex items-center gap-1 text-[10px] font-bold tracking-[0.2em] px-2 py-0.5 rounded-full bg-destructive text-white">
              ...
              <button
                type="button"
                className="self-stretch sm:self-center inline-flex items-center justify-center gap-1 px-4 py-2 rounded-full bg-destructive hover:bg-destructive/90 text-white text-xs font-semibold transition-colors cursor-pointer whitespace-nowrap"
              >
                ดูรายละเอียด
            ...
            >
              <Card
                className="group h-full
                  bg-white/50 border-zinc-200 hover:bg-white/70 hover:shadow-xl hover:shadow-brand/10
              ...
              >
                ...
                <CardContent className="p-5 lg:p-6 2xl:p-8 flex gap-4 relative z-10">
                  <div
                    className="shrink-0 p-3 lg:p-3 2xl:p-4 rounded-2xl bg-brand text-brand-foreground
                      shadow-lg shadow-black/10
                      h-fit ring-1 ring-white/15
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      ...
                      <span className="ml-auto text-[9px] font-bold px-2 py-0.5 rounded-full bg-zinc-100 dark:bg-white/10 text-zinc-700 dark:text-zinc-300 tracking-wider">
                        {item.badge}
                      </span>
                    </div>
