      ...
      {step === 'email' ? (
        ...
        >
          <div className="flex flex-col items-center gap-3 mb-6">
            ...
            <div className="text-center">
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight">ลืมรหัสผ่าน?</h1>
        ...
        >
          <div className="flex flex-col items-center gap-3 mb-6">
            ...
            <div className="text-center">
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight">ยืนยัน OTP</h1>
              <p className="text-xs text-muted-foreground mt-1">
          ...
          <div role="status" className="flex items-start gap-2 rounded-xl px-3 py-2.5 mb-4 text-xs bg-info/10 border border-info/20 text-info">
